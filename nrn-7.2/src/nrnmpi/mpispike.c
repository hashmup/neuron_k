...
void nrnmpi_dbl_gather(double* s, double* r, int n, int root) {
    MPI_Gather(s, n,  MPI_DOUBLE, r, n, MPI_DOUBLE, root, nrnmpi_comm);
}

void nrnmpi_dbl_scatter(double* s, double* r, int n, int root) {
    MPI_Scatter(s, n,  MPI_DOUBLE, r, n, MPI_DOUBLE, root, nrnmpi_comm);
}

void nrnmpi_int_scatter(int* s, int* r, int n, int root) {
    MPI_Scatter(s, n,  MPI_INT, r, n, MPI_INT, root, nrnmpi_comm);
}
